...
<div id="mainForm">
    ...
    <div id="megadiv2">
        <table id="header">
            <tbody>
                <tr>
                    <td rowspan="4" style="text-align:center"><img src="" class="logo" alt=""></td>
                ...
                <tr>
                    <td class="text-center text-bold">PRÁCTICA EMPRESARIAL</td>
        ...
        <br><br>
        <h4 class="text-center">Encuesta Dinámica <hr></h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm">
                    <img src="assets/imgs/larav.png" class="img-fluid" id="withImg" alt="larav">
                </div>
                <div class="col-sm">
                <img src="assets/imgs/flutter.png" class="img-fluid" id="withImg" alt="flutter">
                </div>
            </div>
        </div>
